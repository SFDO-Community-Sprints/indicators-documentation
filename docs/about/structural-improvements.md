...
| **Opinionated / instructional** (Trailhead style) | Given my goal, what should I actually do, and what should I avoid? | [Why Salesforce Indicators](../best-practices/index.md) - "Rule of thumb: Avatar for single-click..." |
