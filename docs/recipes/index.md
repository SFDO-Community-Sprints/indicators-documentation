...
- [**Find a Recipe**](find-a-recipe.md) &mdash; filter every recipe by how it **displays** (Avatar, Badge, Pill, Has Action, Has Extensions) and what it's **for** (Informational, Soft Exceptions, Next Up, Quantitative, Qualitative, Multiple).
